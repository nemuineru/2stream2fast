...
namespace ToonyColorsPro
{
	namespace ShaderGenerator
	{
		public class ShaderGenerator2 : EditorWindow
		{
			...
			internal const string TCP2_VERSION = "2.7.1";
							...
							switch (tag)
							{
								...
								case "PROPERTIES":
									...
									if (allPassesUsedShaderProperties != null && allPassesUsedShaderProperties.Count > 0)
									{
										...
										{
											if (!printedShaderProperties.Contains(sp) && !sp.isMaterialLayerProperty)
											{
								...
								case "FRAGMENT_TEXCOORDS":
								{
									...
									Action<int, bool> printWithGlobalUvAnim = (int uv, bool isVertex) =>
									{
										if (isVertex)
										{
											return;
									...
									if (usedUvChannelsFragment.Count > 0)
									{
										...
										foreach (int uv in usedUvChannelsFragment)
										{
											...
											printWithGlobalUvAnim(uv, false);
										}
